...
The plugin also installs a session guard: if a session changes code while a plan is in flight and no plan file is updated, it asks once for the update before the session ends.
